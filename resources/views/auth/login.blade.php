<div x-data="{
...
}" x-init="init()" class="min-h-screen flex items-center justify-center p-4 transition-all duration-500" :class="darkMode ? 'bg-gradient-to-br from-gray-950 via-gray-900 to-black' : 'bg-gradient-to-br from-orange-500 via-red-500 to-red-600'">
    
    <!-- Theme Toggle Button -->
    <button
        @click="toggleTheme()"
        class="fixed top-6 right-6 p-3 rounded-full shadow-xl hover:scale-110 transition-all duration-300 z-50"
        :class="darkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-white hover:bg-gray-50'"
        title="Toggle theme"
    >
    ...
    <!-- Main Container -->
    <div class="w-full max-w-6xl rounded-2xl shadow-2xl overflow-hidden transition-all duration-500" :class="darkMode ? 'bg-gray-900/95 backdrop-blur-lg' : 'bg-white'">
        <div class="flex flex-col md:flex-row min-h-[600px]">
            ...
            <div class="flex-1 p-8 md:p-12 flex items-center justify-center">
                <div class="w-full max-w-md space-y-6">
                            ...
                            <div class="flex items-center justify-between text-sm pt-2">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input
                                        ...
                                        :class="darkMode 
                                            ? 'bg-gray-800 border-gray-600 text-purple-600 focus:ring-purple-500' 
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex-1 border-t transition-colors duration-300" :class="darkMode ? 'border-gray-700' : 'border-gray-300'"></div>
                        <span class="text-sm transition-colors duration-300" :class="darkMode ? 'text-gray-500' : 'text-gray-400'">Or continue with</span>
                        <div class="flex-1 border-t transition-colors duration-300" :class="darkMode ? 'border-gray-700' : 'border-gray-300'"></div>
                    </div>
                    ...
                    <div class="flex justify-center gap-4">
                        <!-- Google -->
                        <button type="button" class="p-3 rounded-lg border transition-all hover:scale-110" :class="darkMode ? 'bg-gray-800 border-gray-700 hover:bg-gray-750' : 'bg-white border-gray-200 hover:bg-gray-50'" title="Login with Google">
                        ...
                        <!-- Apple -->
                        <button type="button" class="p-3 rounded-lg border transition-all hover:scale-110" :class="darkMode ? 'bg-gray-800 border-gray-700 hover:bg-gray-750' : 'bg-white border-gray-200 hover:bg-gray-50'" title="Login with Apple">
                        ...
                        <!-- Facebook -->
                        <button type="button" class="p-3 rounded-lg border transition-all hover:scale-110" :class="darkMode ? 'bg-gray-800 border-gray-700 hover:bg-gray-750' : 'bg-white border-gray-200 hover:bg-gray-50'" title="Login with Facebook">
            ...
            <div class="hidden md:flex flex-1 items-center justify-center p-12 transition-all duration-500" :class="darkMode ? 'bg-gray-950' : 'bg-gradient-to-br from-gray-300 to-gray-400'">
